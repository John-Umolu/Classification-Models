...
from sklearn.neural_network import MLPClassifier  # use to create and train the model
...
def train_model(X, y):
    ...
    model = MLPClassifier(hidden_layer_sizes=(10, 10),
                          activation="relu", random_state=0, max_iter=2000)
    # train the model
...
fig.suptitle('Neural Network By Umolu John Chukwuemeka (2065655)', color='blue', fontsize=16, fontweight='bold')
# create box to contain the model performance text using the matplotlib.patch.Patch properties
props = dict(boxstyle='round', facecolor='wheat', alpha=0.5)
# set the figure title
fig.canvas.manager.set_window_title('Coursework Task 3: Neural Network By Umolu John Chukwuemeka (2065655)')
